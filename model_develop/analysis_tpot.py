...
# %%
optimizer_pipeline.export('/Users/lin/Documents/python_venvs/tpot_homelike_env/model_develop/optimized_model.py')
...
# %%
joblib.dump(value=fitted_pipeline, filename='gene100_model.model')
# %%
loaded_model = joblib.load(filename='booking_model.model')
# %%
len(X_train.columns)
X_train.columns
# %% make prediction with model
loaded_model.predict([[2, 4, 2, 9, 3, 7, 8]])
